...
export const schemaStatements = [
  ...
  `CREATE INDEX IF NOT EXISTS idx_signal_evaluations_horizon_time ON signal_evaluations(horizon_hours, evaluated_at DESC)`,
  `CREATE INDEX IF NOT EXISTS idx_signal_evaluations_confidence ON signal_evaluations(horizon_hours, confidence, correct)`,
