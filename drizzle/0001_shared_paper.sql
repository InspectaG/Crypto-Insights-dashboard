...
INSERT OR IGNORE INTO paper_accounts (
  id, starting_balance, cash, daily_limit, order_size, minimum_confidence,
  execution_drag_bps, created_at, updated_at, version
) VALUES (
  'shared', 10000, 10000, 1000, 250, 65, 30,
  CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 1
);

INSERT OR IGNORE INTO paper_positions (account_id, symbol, quantity, cost_basis)
VALUES ('shared', 'BTC', 0, 0), ('shared', 'ETH', 0, 0), ('shared', 'SOL', 0, 0);

INSERT OR IGNORE INTO runtime_settings (key, value, updated_at)
VALUES
  ('auto_paper_enabled', 'true', CURRENT_TIMESTAMP),
  ('real_trading_enabled', 'false', CURRENT_TIMESTAMP),
  ('real_trading_kill_switch', 'true', CURRENT_TIMESTAMP),
  ('real_daily_limit', '0', CURRENT_TIMESTAMP);
